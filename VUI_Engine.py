...
def respond(voice_data):
    if there_exists(["al","Hey Baymax"]):
      if there_exists(["al","ow"]):
        engine_speak("Hello, I am Baymax! Your Personal Health care companion. I was Alerted to the Need for Medical attention When you said, Ow!")
      # 1: greeting
      if there_exists(["hi","Hey","Hola", "greetings","wassup","hello","howdy","what's good"]):
